...
def demo_json_mode():
    ...
    print("Usage:")
    print("  # Pipe input")
    print('  echo \'{"message": "Hello"}\' | jay-code --mode json')
    print()
    print("  # Process output")
    print("  jay-code --mode json | jq '.type'")
    print()
    print("  # Integration")
    print("  jay-code --mode json < requests.jsonl > responses.jsonl")
    print()
...
def demo_rpc_mode():
    ...
    print("  jay-code --mode rpc")
    print()
    print("  # Send request")
    print('  echo \'{"id":1,"method":"complete","params":{"message":"Hi"}}\' | jay-code --mode rpc')
    print()
...
# Process
cat requests.jsonl | jay-code --mode json | grep '"type":"message"' > results.jsonl
    """)
