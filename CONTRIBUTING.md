# Contributing to JayClaw

Thank you for your interest in contributing to JayClaw!
...
│   ├── jay-llm/        # LLM API wrapper
│   ├── jay-agent-core/ # Agent runtime
│   └── ...
