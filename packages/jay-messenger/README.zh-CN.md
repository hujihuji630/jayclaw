...
可选依赖：
```bash
pip install jay-messenger[redis]       # 分布式状态管理
pip install jay-messenger[encryption]  # 凭证加密
pip install jay-messenger[telegram]    # Telegram 适配器
pip install jay-messenger[slack]       # Slack 适配器
pip install jay-messenger[discord]     # Discord 适配器
pip install jay-messenger[whatsapp]    # WhatsApp 适配器
pip install jay-messenger[feishu]      # 飞书适配器
pip install jay-messenger[all]         # 所有适配器
```
...
- [GitHub 仓库](https://github.com/hujihuji630/jayclaw)
- [问题反馈](https://github.com/hujihuji630/jayclaw/issues)
