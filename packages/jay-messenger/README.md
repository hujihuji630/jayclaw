...
[![PyPI version](https://badge.fury.io/py/jay-messenger.svg)](https://badge.fury.io/py/jay-messenger)
[![Python](https://img.shields.io/pypi/pyversions/jay-messenger.svg)](https://pypi.org/project/jay-messenger/)
...
```bash
pip install jay-messenger
```

Optional dependencies:
```bash
pip install jay-messenger[redis]       # For distributed state
pip install jay-messenger[encryption]  # For credential encryption
pip install jay-messenger[telegram]    # For Telegram adapter
pip install jay-messenger[slack]       # For Slack adapter
pip install jay-messenger[discord]     # For Discord adapter
pip install jay-messenger[whatsapp]    # For WhatsApp adapter
pip install jay-messenger[feishu]      # For Feishu adapter
pip install jay-messenger[all]         # All adapters
```

## Quick Start

```python
from jay_messenger import MessengerManager, MessengerRegistry, MessengerType
from jay_messenger.adapters.telegram import TelegramMessengerAdapter
...
```python
from jay_messenger.adapters.telegram import TelegramMessengerAdapter, TelegramConfig
...
```python
from jay_messenger.adapters.slack import SlackMessengerAdapter, SlackConfig
...
```python
from jay_messenger.adapters.discord import DiscordMessengerAdapter, DiscordConfig
...
```python
from jay_messenger.adapters.feishu import FeishuAdapter
...
```python
from jay_messenger import MessengerState
...
pip install jay-messenger[dev]

# Run tests
pytest tests/

# Type checking
mypy src/jay_messenger/
...
- [GitHub Repository](https://github.com/hujihuji630/jayclaw)
- [Issue Tracker](https://github.com/hujihuji630/jayclaw/issues)
