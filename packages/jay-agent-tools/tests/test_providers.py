...
import pytest
from jay_agent_tools.web.providers.base import (
    PageContent,
    ReaderProvider,
    SearchProvider,
    SearchResult,
...
async def test_tavily_provider_success():
    from jay_agent_tools.web.providers.tavily import TavilyProvider
...
async def test_exa_provider_success():
    from jay_agent_tools.web.providers.exa import ExaProvider
...
def test_get_default_provider_tavily(monkeypatch):
    from jay_agent_tools.web.providers import TavilyProvider, get_default_provider
...
def test_get_default_provider_exa(monkeypatch):
    from jay_agent_tools.web.providers import ExaProvider, get_default_provider
...
def test_get_default_provider_no_key(monkeypatch):
    from jay_agent_tools.web.providers import FallbackSearchProvider, get_default_provider
...
async def test_jina_reader_success_json():
    from jay_agent_tools.web.providers.jina import JinaReaderProvider
...
async def test_httpx_bs4_success():
    from jay_agent_tools.web.providers.httpx_bs4 import HttpxBs4Provider
...
def test_get_default_reader_returns_jina():
    from jay_agent_tools.web.providers import JinaReaderProvider, get_default_reader
