...
def register_tools(registry=None):
    ...
    Args:
        registry: Optional ToolRegistry instance. If None, registers with global registry.
                 Supports both old ToolRegistry (from jay_agent_core.registry) and
                 new ToolRegistry (from jay_agent_core.tools.registry).
    ...
    if hasattr(registry, "_handlers"):
        ...
        raise TypeError(
            ...
            "Please use the new ToolRegistry from jay_agent_core.tools.registry, "
