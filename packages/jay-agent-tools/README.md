...
Tool extensions for jay-agent-core.

## Installation

```bash
# Install base package
pip install jay-agent-tools
...
```python
from jay_agent_tools.web import handle_search_web, handle_read_webpage
...
from jay_agent_tools.web import TOOL_SCHEMAS, HANDLERS
...
pytest tests/ --cov=jay_agent_tools --cov-report=html
```
