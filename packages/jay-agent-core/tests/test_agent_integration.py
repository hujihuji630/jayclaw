...
from jay_agent_core.agent import Agent  # noqa: E402
from jay_agent_core.observability.events import AgentEvent  # noqa: E402
from jay_agent_core.resilience.profile import APIProfile, ProfileManager  # noqa: E402
...
def test_event_callback_integration():
    ...
    from jay_agent_core.observability.events import (
        AgentEvent as Event,
    )
    from jay_agent_core.observability.events import (
        AgentEventType,
