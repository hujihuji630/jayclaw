...
def test_all_exports_available():
    ...
    import jay_agent_core

    # Core
    assert hasattr(jay_agent_core, "Agent")
    assert hasattr(jay_agent_core, "Tool")

    # Memory
    assert hasattr(jay_agent_core, "MemoryProvider")
    assert hasattr(jay_agent_core, "InMemoryProvider")
    assert hasattr(jay_agent_core, "Message")

    # Context
    assert hasattr(jay_agent_core, "ContextLoader")
    assert hasattr(jay_agent_core, "SystemPromptBuilder")
    assert hasattr(jay_agent_core, "CompressionConfig")
    assert hasattr(jay_agent_core, "compress_messages")

    # Observability
    assert hasattr(jay_agent_core, "AgentEvent")
    assert hasattr(jay_agent_core, "AgentEventType")
    assert hasattr(jay_agent_core, "BillingHook")
    assert hasattr(jay_agent_core, "emit_profile_rotated")
    assert hasattr(jay_agent_core, "emit_context_compressed")
    assert hasattr(jay_agent_core, "emit_model_fallback")

    # Resilience
    assert hasattr(jay_agent_core, "ProfileManager")
    assert hasattr(jay_agent_core, "FailoverReason")
    assert hasattr(jay_agent_core, "classify_failure")
    assert hasattr(jay_agent_core, "resilient_call")
    assert hasattr(jay_agent_core, "resilient_streaming_call")
    assert hasattr(jay_agent_core, "ResilienceExhaustedError")

    # Token counting
    assert hasattr(jay_agent_core, "count_tokens")

    # Tool system
    assert hasattr(jay_agent_core, "EnhancedToolRegistry")
    assert hasattr(jay_agent_core, "EnhancedToolResult")
    assert hasattr(jay_agent_core, "ToolAuditLog")
    assert hasattr(jay_agent_core, "ToolMetrics")
    assert hasattr(jay_agent_core, "ToolMetricsCollector")
...
def test_billing_hook_protocol():
    ...
    from jay_agent_core import BillingHook
...
def test_context_loader_protocol():
    ...
    from jay_agent_core import ContextLoader
...
def test_system_prompt_builder_protocol():
    ...
    from jay_agent_core import SystemPromptBuilder
...
def test_enhanced_tool_registry_available():
    ...
    from jay_agent_core import EnhancedToolRegistry
...
def test_resilience_components_available():
    ...
    from jay_agent_core import FailoverReason, ProfileManager, classify_failure
...
def test_token_counter_available():
    ...
    from jay_agent_core import count_tokens
...
def test_audit_and_metrics_available():
    ...
    from jay_agent_core import ToolAuditLog, ToolMetricsCollector
