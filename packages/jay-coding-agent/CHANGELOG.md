...
All notable changes to jay-coding-agent will be documented in this file.
...
- Updated dependency to `jay-agent-core>=0.0.4` for enhanced features
...
- Seamless integration with jay-agent-core v0.0.4 protocols
