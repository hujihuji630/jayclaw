...
This guide helps you upgrade jay-coding-agent from v0.0.3 to v0.0.4.
...
```bash
pip install --upgrade jay-coding-agent
```

Or with uv:

```bash
uv pip install --upgrade jay-coding-agent
```
...
- [ ] Upgrade package: `pip install --upgrade jay-coding-agent`
...
```bash
# Ensure jay-agent-core v0.0.4 is installed
pip install jay-agent-core>=0.0.4
...
```bash
pip install jay-coding-agent==0.0.3
```
