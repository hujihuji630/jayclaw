...
[![PyPI version](https://badge.fury.io/py/jay-web-ui.svg)](https://badge.fury.io/py/jay-web-ui)
[![Python](https://img.shields.io/pypi/pyversions/jay-web-ui.svg)](https://pypi.org/project/jay-web-ui/)
...
- 🔌 **Easy Integration**: Works with jay-agent-core
- 📱 **Mobile Friendly**: Responsive design

## Installation

```bash
pip install jay-web-ui
```
...
```python
from jay_web_ui import ChatServer
...
```bash
# Use gunicorn
gunicorn jay_web_ui.app:create_app -k uvicorn.workers.UvicornWorker
```
...
ChatServer
    ↓
Agent/LLM (jay-agent-core/jay-llm)
```
