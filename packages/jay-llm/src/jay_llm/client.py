...
class LLM:
    ...
    def _init_provider(self):
        ...
        if entry:
            ...
            mod = importlib.import_module(f".providers.{module_name}", package="jay_llm")
    ...
    async def astream(
        ...
        **kwargs,
        ...
        """Alias for achat_stream for compatibility."""
        async for chunk in self.achat_stream(messages=messages, **kwargs):
            yield chunk
