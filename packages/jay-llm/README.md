...
[![PyPI version](https://badge.fury.io/py/jay-llm.svg)](https://badge.fury.io/py/jay-llm)
[![Python](https://img.shields.io/pypi/pyversions/jay-llm.svg)](https://pypi.org/project/jay-llm/)
...
```python
from jay_llm import LLM, Config
